...
write_file = 'c0129_gauss_fit_params2.dat'
file = open(write_file, 'w')

#dir_path = u'/home/cmutnik/work/PHYS399/c0129/data/calib'
...
def plotcontour():
    ...
    file.write(str(height) + "\t" + str(y) + "\t" + str(x) + "\t#" + str(file_name) + "\n") #y and x are flipped variables
    waist_ = np.sqrt(width_x*width_x + width_y*width_y)
